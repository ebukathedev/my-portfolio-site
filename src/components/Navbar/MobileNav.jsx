...
const sideBarStyles =
	"fixed z-40 flex md:hidden top-0 right-0 bottom-0 h-screen bg-light-navy-green w-[75vw] max-w-[400px] py-[50px] px-[10px] justify-center items-center transition-all duration-300 ease-in-out mobile-links";
